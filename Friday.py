...
if __name__=='__main__':
    ...
    while True:
        ...
        if 'wikipedia' in statement:
            ...
            app_id = "XALW8A-YHXLYR8RVX"      # Paste your unique ID here
            client = wolframalpha.Client('XALW8A-YHXLYR8RVX')
            ...
            webbrowser.open_new_tab("https://github.com/SatYu26")
            speak("Here is GitHub")

        elif "who made you" in statement or "who created you" in statement or "who discovered you" in statement:
            speak("I was built by Satyam")
            print("I was built by Satyam")
